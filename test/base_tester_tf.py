...
class BaseTester:
    def __init__(self, report_directory, fmri_tensor, eeg_tensor, eeg_transformer, first_test_frame, last_test_frame,
        ...
        self.net = torch.load(os.path.join(report_directory, 'net_final')).cuda().eval()
    ...
    def test(self):
        ...
        while time < self.last_test_frame * self.frame_creation_time:
            ...
            residual_loss_list.append(np.sqrt((ground_truth_slice - output_slice)**2/(ground_truth_slice * ground_truth_slice + 1e-9)))
