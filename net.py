...
class Net(nn.Module):
    def __init__(self):
        super().__init__()
        self.down_block64 = nn.Sequential(ResBlock(65, 32),
                                     ResBlock(65, 32),
                                     ResBlock(65, 32),
                                     DownBlock(65, 128))

        self.down_block32 = nn.Sequential(ResBlock(128, 32),
                                     ResBlock(128, 32),
                                     ResBlock(128, 32),
                                     ResBlock(128, 32),
                                     DownBlock(128, 256))

        self.down_block16 = nn.Sequential(ResBlock(256, 32),
                                     ResBlock(256, 32),
                                     ResBlock(256, 32),
                                     ResBlock(256, 32),
                                     ResBlock(256, 32),
        ...
        self.block8 = nn.Sequential(ResBlock(256, 32),
                                    ResBlock(256, 32),
                                    ResBlock(256, 32),
                                    ResBlock(256, 64),
                                    ResBlock(256, 64),
        ...
        self.up_block32 = nn.Sequential(ResBlock(256, 64),
                                        ResBlock(256, 64),
                                        ResBlock(256, 64),
                                        ResBlock(256, 64),
                                        UpBlock(256, 128)
